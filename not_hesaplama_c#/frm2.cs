    ...
    public partial class frm2 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //else if (textBox1.Text == "") MessageBox.Show("Vize Notu Boş Bırakılamaz, Lütfen 0 ile 100 Arasında Bir Değer Giriniz!");
                //else if (textBox2.Text == "") MessageBox.Show("Final Notu Boş Bırakılamaz, Lütfen 0 ile 100 Arasında Bir Değer Giriniz!");
                //else if (comboBox1.Text == "") MessageBox.Show("Vize Yüzdesi Boş Bırakılamaz Lütfen Uygun Vize Yüzdesini Seçiniz!");
                //else if (comboBox2.Text == "") MessageBox.Show("Final Yüzdesi Boş Bırakılamaz Lütfen Uygun Final Yüzdesini Seçiniz!");
                //kod bloğu çalışmıyor direk catch bloğu çalışıyor hocaya sor.
                else
                {
